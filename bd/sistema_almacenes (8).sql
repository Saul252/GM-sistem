...
--
-- Servidor: localhost
-- Tiempo de generación: 27-06-2026 a las 02:01:44
...
--
-- Estructura de tabla para la tabla `comprobantes_de_pago`
--
...
CREATE TABLE `comprobantes_de_pago` (
  ...
  `almacen_id` int(11) NOT NULL,
  `metodo_pago` varchar(250) NOT NULL DEFAULT 'efectivo',
  `estado` varchar(250) NOT NULL DEFAULT 'activo',
  `numero_ventas` varchar(250) NOT NULL,
...
CREATE TABLE `confirmacion_reparto_viaje` (
  ...
  `comentario` text DEFAULT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `entrega_id` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `ventas` (
  ...
  `observaciones` text DEFAULT NULL,
  `vendedor_id` int(11) DEFAULT 1,
  `factura` varchar(250) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
--
-- Indices de la tabla `comprobantes_de_pago`
--
ALTER TABLE `comprobantes_de_pago`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `comprobantes_de_pago`
--
ALTER TABLE `comprobantes_de_pago`
