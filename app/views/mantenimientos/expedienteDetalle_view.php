...
<div class="d-flex justify-content-center px-2">
    <div class="card border-0 shadow-sm mb-3 " style="max-width: 1200px;">
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>
    ...
    const URL_CONTROLLER = '/cfsistem/app/controllers/mantenimientosController.php';
   ...
   <script>async function imprimirEstadoCuenta() {
    try {
        ...
        const res = await fetch(
            `/cfsistem/app/controllers/historialInsumosController.php?action=getEstadoCuentaCliente&fecha_inicio=${encodeURIComponent(fechaInicio)}&fecha_fin=${encodeURIComponent(fechaFin)}`
        );
...
`;
    ...
    function filtrarExpediente() {
        ...
        window.location.href =
            `/cfsistem/app/controllers/historialInsumosController.php?&fecha_inicio=${fechaInicio}&fecha_fin=${fechaFin}`;
...
async function abrirDetalleSalida(id){
        ...
        const res = await fetch(
            `/cfsistem/app/controllers/historialInsumosController.php?action=getInsumo&id=${id}`
        );
