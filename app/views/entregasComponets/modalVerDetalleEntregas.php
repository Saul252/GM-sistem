...
window.verEntrega = async function(movimientoId) {
    ...
    try {
        ...
        const url = `entregasController.php?ajax=get_resumen_despacho&id=${movimientoId}`;
                    ...
                    <div class="card border-0 shadow-sm animate__animated animate__fadeIn" style="border-radius: 24px; background: linear-gradient(145deg, #f0f7ff, #ffffff);">
                        <div class="card-body p-4">
                            ...
                            <div class="p-3 bg-white rounded-4 border border-light shadow-sm mb-3">
                                <div class="row">
                                    <div class="col-6">
                                        <label class="text-body-secondary small d-block mb-1" style="font-weight: 600;"><i class="bi bi-calendar-event text-primary me-1"></i>Fecha Salida</label>
                                        <span class="fw-bold text-dark" style="font-size: 0.8rem;">${d.fecha_patio || d.fecha_movimiento}</span>
                                    </div>
                                    <div class="col-6 border-start">
                                        <label class="text-body-secondary small d-block mb-1" style="font-weight: 600;"><i class="bi bi-geo-alt-fill text-danger me-1"></i>Destino</label>
                            ...
                            <div class="pt-3 border-top">
                                <label class="text-body-secondary small d-block mb-2" style="font-weight: 600;">Ayudantes:</label>
                ...
                htmlBody = `
                    <div class="card border-0 shadow-sm animate__animated animate__fadeIn" style="border-radius: 24px; background: linear-gradient(145deg, #f2fdf5, #ffffff);">
                        <div class="card-body p-4">
                            ...
                            <div class="p-3 bg-white rounded-4 border border-light shadow-sm mb-3">
                                <label class="text-body-secondary d-block small mb-1" style="font-weight: 600;"><i class="bi bi-clock-history text-success me-1"></i>Fecha Despacho</label>
