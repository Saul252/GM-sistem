 ...
 */
async function repartosDespachos(ventaId,almacenId) {
    ...
    try {
        ...
        const respIds = await fetch(`${URL_ENTREGAS}?ajax=entregas_pendientes&venta_id=${ventaId}`);
...
async function ejecutarSalidaMasivaFinal(ids, boton) {
    ...
    try {
        ...
        formData.append('ajax', 'despachar_venta_completaFaltantesEntrega'); 
