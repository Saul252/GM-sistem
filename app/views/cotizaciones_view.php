    ...
    async function gestionarSolicitud(id) {
        try {
            ...
            const footer = `
                ...
                <button class="btn btn-dark rounded-pill px-4 " id=""
                    class="btn btn-success"onclick="procederPago(${totalGeneral},${id})"
                    >
                    Convertir a Venta
                </button>
           ...
           `
            ...
            new bootstrap.Modal(
                document.getElementById('modalImprimirSolicitud')
            ).show();
