...
<body>
    ...
    <script>
        ...
        async function getMantenimientos() {
            ...
            try {
                const res = await fetch(`/cfsistem/app/controllers/verificacionesController.php?${params.toString()}`);
        ...
        async function verDetalle(id) {
            try { 
                const resp = await fetch(`/cfsistem/app/controllers/verificacionesController.php?action=obtenerDetalle&id=${id}`);
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            try {
                ...
                const response = await fetch('/cfsistem/app/controllers/verificacionesController.php?action=eliminar', {
                    method: 'POST',
                    body: formData
                });
