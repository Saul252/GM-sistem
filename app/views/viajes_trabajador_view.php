...
<body>
            ...
            <div class="glass-card p-4 mb-4">
                <form id="formFiltros" class="row g-3">
                    ...
                    <div class="col-md-2">
                        ...
                        <select id="almacen_select" class="form-select ios-input" <?= ($almacen_sesion != 0) ? 'disabled' : '' ?>>
                    ...
                    <div class="col-md-2">
                        <button type="button" onclick="AppLogistica.cargar()" class="btn btn-primary w-100 fw-bold">
                            Consultar
                        </button>
                    </div>
    ...
    <script>
        ...
        const AppLogistica = {
            ...
            url: '/cfsistem/app/controllers/viajesTrabajadoresController.php',
