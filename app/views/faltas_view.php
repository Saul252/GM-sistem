...
<div class="col-md-2">
    ...
    <script>
    let tabla;
    const CONTROLLER = '/cfsistem/app/controllers/faltasController.php';
    ...
    async function cargarDatosAlmacen(almacenId, esParaModal = false) {
        ...
        try {
            const resp = await fetch(
                `/cfsistem/app/controllers/faltasController.php?action=ajax&almacen_id=${almacenId}&periodo=${periodo}&f_inicio=${f_inicio}&f_fin=${f_fin}`
            );
