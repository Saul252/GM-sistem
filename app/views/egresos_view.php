...
<body class="">
                    ...
                    <div class="d-flex gap-2 justify-content-md-end">
                        ...
                        <div class="d-flex align-items-center justify-content-between gap-3 p-2.5 action-bar">
                            <div class="d-flex align-items-center gap-2">
                                <button type="button"
                                    class="btn btn-sm btn-action-slate px-3 py-2 d-inline-flex align-items-center gap-2"
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <button type="button"
                                    class="btn btn-sm btn-action-warning px-3 py-2 d-inline-flex align-items-center gap-2"
                                    onclick="abrirModalGasto()">
                                    <i class="bi bi-cash-stack fs-6"></i>
                                    <span>Nuevo Gasto</span>
                                </button>
                                <button type="button"
                                    class="btn btn-sm btn-action-primary px-3 py-2 d-inline-flex align-items-center gap-2"
                        ...
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-2">
                                ...
                                <select id="filtro_rapido" name="periodo_filtro"
                                    ...
                                    <option value="personalizado" <?= ($periodo_sel == 'personalizado') ? 'selected' : '' ?>>📅 Personalizado
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="col-md-2 div-fechas <?= ($periodo_sel !== 'personalizado') ? 'd-none' : '' ?>">
                                ...
                                <input type="date" name="desde" id="fecha_desde"
                                    class="form-control  border border-subtle" style="border-radius: 10px;"
                            ...
                            <div class="col-md-2">
                                ...
                                <select name="metodo_filtro" id="metodo_filtro" class="form-select">
                                    ...
                                    <option value="efectivo" <?= $metodo_filtro == 'efectivo' ? 'selected' : '' ?>>Efectivo
                                    </option>
                                    <option value="transferencia" <?= $metodo_filtro == 'transferencia' ? 'selected' : '' ?>>Transferencia</option>
                                    <option value="tarjeta" <?= $metodo_filtro == 'tarjeta' ? 'selected' : '' ?>>Tarjeta
                                    </option>
                                </select>
                            </div>
                            <div class="col-md-2">
                            ...
                            <div class="col-md-2 d-none animate__animated animate__fadeIn" id="contenedor_categoria">
                                <label
                                    class="form-label fw-bold small text-uppercase text-body-secondary">Categoría</label>
                    ...
                    <table class="table table-hover align-middle mb-0" id="egresosTabla">
                        <thead style="background-color: #f8f9fa; border-bottom: 2px solid #f1f3f5;">
                            <tr class="text-secondary">
                                <th class="ps-4 py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">ID</th>
                                <th class="py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Almacén</th>
                                <th class="py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Fecha</th>
                                <th class="py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Folio</th>
                                <th class="py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Tipo</th>
                                <th class="py-3 fw-bold text-uppercase"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Entidad</th>
                                <th class="py-3 fw-bold text-uppercase text-center"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Deuda</th>
                                <th class="py-3 fw-bold text-uppercase text-end"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Total</th>
                                <th class="py-3 fw-bold text-uppercase text-end"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Método</th>
                                <th class="py-3 fw-bold text-uppercase text-center"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Estado</th>
                                <th class="py-3 fw-bold text-uppercase text-center"
                                    style="font-size: 0.75rem; letter-spacing: 0.5px;">Doc</th>
                                <th class="py-3 fw-bold text-uppercase text-end pe-4"
                            ...
                            <?php if (!empty($egresos)): ?>
                                <?php foreach ($egresos as $e): ?>
                                    <tr class="border-bottom" style="transition: all 0.2s ease;">
                                        ...
                                        <td class="ps-4">
                                            <span
                                                class=" border border-subtle card-title-text border fw-medium">#<?= $e['id'] ?></span>
                                        </td>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                <span
                                                    class="fw-medium card-title-text small"><?= htmlspecialchars($e['almacen_nombre'] ?? 'N/A') ?></span>
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            if ($e['tipo'] == 'pago_deuda')
                                                $bg_tipo = 'bg-primary bg-opacity-10 text-primary border-primary';
                                            ?>
                                            <span class=" border py-1.5 px-2 fw-semibold text-uppercase <?= $bg_tipo ?>"
                                        ...
                                        <td>
                                            <div class="card-title-text fw-medium small text-truncate"
                                        ...
                                        <td class="text-center">
                                            <?php if ($e['tipo'] == 'compra'): ?>
                                                <?php if (($e['piezas_faltantes'] ?? 0) > 0): ?>
                                                    <span class=" bg-white text-danger border border-danger fw-bold shadow-sm"
                                                        style="font-size: 0.7rem;">
                                                        - <?= number_format($e['piezas_faltantes'], 2) ?>
                                                    </span>
                                                <?php else: ?>
                                                    <span
                                                        class=" bg-success bg-opacity-10 text-success border border-success rounded-circle">
                                                ...
                                                <?php if (!empty($e['documento_url'])): ?>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <button class="btn btn-sm btn-light border position-relative" type="button"
                                                            ...
                                                            <span
                                                                class="position-absolute top-0 start-100 translate-middle  rounded-pill bg-primary">
                                                                <?= count($documentos) ?>
                                                            </span>
                                        ...
                                        <td class="text-end pe-4">
                                            <div class="d-flex justify-content-end gap-1">
                                                ...
                                                <?php if ($e['tiene_deuda'] == 1): ?>
                                                    <button class="btn btn-sm btn-danger shadow-sm px-2"
                                                        onclick="abrirDeudaCompra(<?= $e['id'] ?>)" title="Pagar Deuda">
                                                ...
                                                <?php if ($e['tipo'] != 'pago_deuda'): ?>
                                                    <?php if ($e['tipo'] != 'gasto'): ?>
                                                        <button class="btn btn-sm btn-light border shadow-sm px-2 text-primary"
                                                    ...
                                                    <?php if ($e['tipo'] == 'gasto'): ?>
                                                        <button class="btn btn-sm btn-light border shadow-sm px-2 text-primary"
                                                            onclick="gastoDetalle_cargarVista('gasto', <?= $e['id'] ?>)">
                                                            <i class="bi bi-eye-fill"></i>
                                                        </button>
                                                    <?php endif; ?>
    ...
    <?php require_once __DIR__ . '/egresosComponets/modalDetalleGasto.php'; ?>
