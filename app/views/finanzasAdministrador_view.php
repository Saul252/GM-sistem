    ...
    <main class="main-content">
        <div class="container-fluid">
            ...
            <div class="row mb-4 g-3 border-0 shadow-sm h-100" style="border-radius: 15px;background: var(--card-header-bg)!important;">
                ...
                <div class="col-md-6 card border-0 shadow-sm h-100" style="border-radius: 15px;">
                    <table class="table table-hover mb-0 text-center">
                        <thead class="">
                            <tr>
                                <th class="py-3 border-0 text-body-secondary small">CONCEPTO</th>
                                <th class="py-3 border-0 text-body-secondary small">EFECTIVO</th>
                                <th class="py-3 border-0 text-body-secondary small">TARJETA</th>
                                <th class="py-3 border-0 text-body-secondary small">TRANSFERENCIA</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
