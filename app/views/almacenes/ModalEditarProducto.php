...
function editarProducto(productoId, almacenId) {
    ...
    fetch(`/cfsistem/app/controllers/almacenes.php?action=getProducto&id=${productoId}&almacen_id=${almacenId}`)
        .then(res => res.text())
        .then(text => {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    formEditar.addEventListener('submit', function(e) {
        ...
        fetch('/cfsistem/app/controllers/almacenes.php?action=actualizarProducto', {
                method: 'POST',
                body: formData
            })
