...
function guardarGasto() {
    ...
    fetch('/cfsistem/app/controllers/egresosController.php?action=guardarGastoInsumo', {
            method: 'POST',
            body: formData
        })
        .then(res => {
...
async function agregarFilaGasto() {
    const resp = await fetch(
        `/cfsistem/app/controllers/egresosController.php?action=obtenerInsumosSelect`
    );
