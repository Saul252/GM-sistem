...
const AppLogistica = {
    ...
    url: '/cfsistem/app/controllers/pagos_viajesController.php',
...
async function cargarTrabajadores() {
    try {
        ...
        const res = await fetch('/cfsistem/app/controllers/trabajadoresController.php?action=getTrabajadores');
...
async function eliminarPago(id) {
    ...
    try {
        ...
        const res = await fetch('/cfsistem/app/controllers/pagos_viajesController.php?action=eliminarPagoPorViaje', {
            method: 'POST',
            body: fd
        });
