 ...
 <div class="modal fade" id="modalGestionSolicitud" tabindex="-1" data-bs-backdrop="static">
    ...
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" style="max-width: 95vw; width: 95vw; height: 92vh;">
        <div class="modal-content border-0 shadow-lg h-100" style="border-radius: 16px; overflow:hidden;">
            ...
            <!-- El <form> envuelve TODO (Header, Body y Footer) para que funcione como contenedor flexible -->
            <form id="formConvertirCompra" enctype="multipart/form-data" class="d-flex flex-column h-100 m-0">

                <!-- HEADER -->
                <div class="modal-header bg-success text-white px-4 py-3 border-0 flex-shrink-0">
                    <div>
                ...
                <!-- MODAL BODY: flex-grow-1 y overflow-y-auto obligatorios para el scroll interno -->
                <div class="modal-body border border-subtle px-4 py-4 flex-grow-1 overflow-y-auto">
                    ...
                    <div class="rounded-4 shadow-sm p-4 mb-4 border">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <small class="text-body-secondary">Datos generales de la entrada</small>
                            </div>
                        ...
                        <div class="row g-3">
                            <!-- ALMACÉN -->
                            <div class="col-md-3">
                                <label class="form-label small fw-bold text-body-secondary text-uppercase">Almacén destino</label>
                                <?php if (isset($es_admin) && $es_admin): ?>
                                <select id="almacen_id2" name="almacen_id2" class="form-select rounded-3 shadow-sm" required>
                                ...
                                <?php else: ?>
                                <input type="text" class="form-control rounded-3 shadow-sm border border-subtle fw-bold" value="<?= htmlspecialchars($almacenes[0]['nombre'] ?? 'Almacén Asignado') ?>" readonly>
                                <input type="hidden" id="almacen_id2" name="almacen_id2" value="<?= $almacen_usuario ?? ($almacenes[0]['id'] ?? '') ?>">
                                <?php endif; ?>
                            </div>

                            <!-- PROVEEDOR -->
                            <div class="col-md-3">
                                <label class="form-label small fw-bold text-body-secondary text-uppercase">Proveedor</label>
                                <input type="text" id="uni-proveedor" class="form-control rounded-3 shadow-sm border border-subtle fw-bold" readonly>
                                <input type="hidden" name="proveedor" id="uni-proveedor-nombre">
                            </div>

                            <!-- FOLIO -->
                            <div class="col-md-2">
                                <label class="form-label small fw-bold text-body-secondary text-uppercase">Folio factura</label>
                                <input type="text" name="folio" class="form-control rounded-3 shadow-sm" placeholder="FAC-000" required>
                            </div>

                            <!-- MÉTODO -->
                            <div class="col-md-2">
                                <label class="form-label small fw-bold text-body-secondary text-uppercase">Método pago</label>
                                <select name="metodo_pago" id="metodo_pago" class="form-select rounded-3 shadow-sm" required>
                            ...
                            <!-- EVIDENCIA -->
                            <div class="col-md-2">
                                <label class="form-label small fw-bold text-body-secondary text-uppercase">Evidencia</label>
                                <input type="file" name="evidencia_compra" class="form-control rounded-3 shadow-sm" accept="image/*,.pdf">
                            </div>
                        </div>
                        ...
                        <div class="row g-3 mt-2 align-items-stretch">
                            ...
                            <div class="col-md-4">
                                <div class="bg-danger-subtle border border-danger-subtle rounded-4 p-3 h-100">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div>
                                            <small class="text-danger fw-semibold d-block mb-1">Deuda actual proveedor</small>
                                            <input type="text" name="deudaProveedor" id="uni-proveedor-deuda" class="form-control border-0 bg-transparent text-danger fw-bold fs-4 p-0" readonly>
                                        </div>
                            ...
                            <div class="col-md-3">
                                <div class="bg-primary-subtle border border-primary-subtle rounded-4 p-3 h-100">
                                    <label class="form-label small text-primary fw-bold mb-2">
                                        <i class="bi bi-cash-coin me-1"></i> Abono a deuda
                                    </label>
                                    <input type="number" id="input_pagar_deuda" name="saldo_a_pagar" class="form-control border-primary shadow-sm rounded-3" value="0" min="0" step="0.1">
                            ...
                            <div class="col-md-5">
                                <div class="bg-success-subtle border border-success-subtle rounded-4 p-3 h-100 text-end">
                                    <small class="text-success fw-semibold text-uppercase d-block mb-2">Total compra</small>
                                    <span class="fw-bold text-success" id="uni-gran-total" style="font-size:2rem;">$ 0.00</span>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-4 shadow-sm border overflow-hidden">
                        <div class="p-3 border-bottom border-subtle">
                            ...
                            <small class="text-body-secondary">Conversión de unidades y costos</small>
                        </div>
                        <div class="table-responsive">
                ...
                <!-- FOOTER: flex-shrink-0 para evitar que se comprima o desaparezca -->
                <div class="modal-footer border-top border-subtle px-4 py-3 flex-shrink-0 bg-white">
