        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6">
                <div class="d-flex flex-wrap justify-content-lg-end gap-2 mt-3 mt-lg-0">
                    ...
                    <a href="/cfsistem/app/controllers/historialInsumosController.php"
...
<div class="modal fade" id="modalDetalleMantenimiento" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none; overflow: hidden; box-shadow: 0 15px 50px rgba(0,0,0,0.25);">
            ...
            <div class="modal-body p-4 bg-light">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-3 p-3 text-center bg-white">
                    ...
                    <p class="text-muted small mb-0">Registrado en sistema el: <span id="det-creado_en"></span></p>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm rounded-4 p-3 h-100 bg-white">
                            ...
                            <div class="mb-2">
                                <small class="text-muted d-block">Ubicación / Almacén de Cargo</small>
                                <span class="fw-bold text-dark" id="det-almacen"></span>
                            </div>
                            <div class="row pt-2 border-top">
                                <div class="col-6 border-end">
                                    <small class="text-muted d-block">Fecha Efectuada</small>
  ...
  $(document).ready(function() {
    ...
    async function getMantenimientos() {
        ...
        try {
            ...
            const data = await res.json();https://modems-worthy-stay-submit.trycloudflare.com/cfsistem/
...
async function verDetalle(id) {
        try { 
            ...
            const respIds = await fetch(
                `/cfsistem/app/controllers/mantenimientosController.php?action=obtenerDetalle&id=${id}`
            );
