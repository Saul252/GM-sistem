<div class="modal fade" id="modalVerificacion" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-centered">
        <div class="modal-content" style="border-radius: 20px; border: none; width: 95%; max-width: 1140px; overflow: hidden; box-shadow: 0 15px 50px rgba(0,0,0,0.2);">
            <form id="formSolicitud" novalidate> <div class="modal-header  border-0 pt-4 px-4 pb-2">
...
$(document).ready(function() {
    ...
    $('#formSolicitud').on('submit', async function(e) {
        ...
        try {
            const resp = await fetch(`/cfsistem/app/controllers/verificacionesController.php?action=guardar`, {
                method: 'POST',
                headers: {
