...
async function recargarProductosEditar() {
    try {
        const resp = await fetch(`/cfsistem/app/controllers/cotizacionesController.php?action=obtenerProductos`);
  ...
  cantidadTotal=cantidadT.toFixed(2);
    ...
    try {
        ...
        const resp = await fetch(
            `/cfsistem/app/controllers/editarVentaController.php?action=guardarEdicion`, {
                method: 'POST',
                headers: {
...
async function gestionarSolicitud(id) {
    try {
        ...
        const resp = await fetch(
            `/cfsistem/app/controllers/editarVentaController.php?action=obtenerDetalle&id=${id}`);
...
async function guardarComoGastoSalidadeDinero() {
    ...
    try {
        ...
        const resp = await fetch(
            '/cfsistem/app/controllers/egresosController.php?action=guardarGasto',
            {
                method: 'POST',
                body: fd
            }
