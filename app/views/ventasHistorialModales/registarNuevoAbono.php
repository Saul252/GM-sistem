...
async function abrirNuevoAbono(id) {
    ...
    try {
        const resp = await fetch(
            `/cfsistem/app/controllers/registrarPagosController.php?action=obtenerPagoFaltante&id=${id}`
        );
...
console.log("k",referencia);
    try {
        ...
        const res = await fetch(`/cfsistem/app/controllers/registrarPagosController.php?action=guardarAbono`, { method: 'POST', body: fd });
