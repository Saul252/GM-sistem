        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-4 gap-3 w-100">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <button class="btn btn-primary rounded-pill px-4 shadow-sm d-flex align-items-center"
                    onclick="nuevoTrabajador()" style="height: 34px; font-weight: 600; font-size: 0.85rem;">
                                                    ...
                                                    <li>
                                                        <h6
                                                            ...
                                                            <button class="btn btn-sm btn-outline-primary rounded-pill"
                                                                onclick="subirDocumentoCompra(<?= $t['id'] ?>)">
                                                        ...
                                                        <li>
                                                            <div
                                                                ...
                                                                <a href="../../<?= htmlspecialchars($direccion) ?>" target="_blank"
                                                                    class="text-decoration-none flex-grow-1 text-truncate me-2">
                                ...
                                <td class="text-end">
                                    <div class="btn-group">
                                        <button class="btn btn-sm btn-outline-primary"
                                            onclick="editarTrabajador(<?= htmlspecialchars(json_encode($t), ENT_QUOTES, 'UTF-8') ?>)">
        ...
        async function subirDocumentoCompra(trabajador_id) {
            ...
            `,
                ...
                preConfirm: async () => {
                    ...
                    try {
                        const response = await fetch('/cfsistem/app/controllers/trabajadoresController.php?action=subirDocumento', {
                            method: 'POST',
                            body: formData
                        });
